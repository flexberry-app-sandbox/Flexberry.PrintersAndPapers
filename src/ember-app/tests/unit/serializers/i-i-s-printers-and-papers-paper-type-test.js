...
moduleForModel('i-i-s-printers-and-papers-paper-type', 'Unit | Serializer | i-i-s-printers-and-papers-paper-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-printers-and-papers-paper-type',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
