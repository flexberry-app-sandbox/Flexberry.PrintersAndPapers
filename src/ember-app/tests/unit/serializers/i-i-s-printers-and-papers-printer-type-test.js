...
moduleForModel('i-i-s-printers-and-papers-printer-type', 'Unit | Serializer | i-i-s-printers-and-papers-printer-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-printers-and-papers-printer-type',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
