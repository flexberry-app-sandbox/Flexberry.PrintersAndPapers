...
moduleForAcceptance('[AGAT] Acceptance | i i s printers and papers printer l');

test('testing i-i-s-printers-and-papers-printer-l', function(assert) {
  visit('/i-i-s-printers-and-papers-printer-l');
