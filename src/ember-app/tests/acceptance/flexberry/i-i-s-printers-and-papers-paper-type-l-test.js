...
moduleForAcceptance('[AGAT] Acceptance | i i s printers and papers paper type l');

test('testing i-i-s-printers-and-papers-paper-type-l', function(assert) {
  visit('/i-i-s-printers-and-papers-paper-type-l');
