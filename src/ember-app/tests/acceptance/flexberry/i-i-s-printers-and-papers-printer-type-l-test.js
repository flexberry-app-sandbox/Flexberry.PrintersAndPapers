...
moduleForAcceptance('[AGAT] Acceptance | i i s printers and papers printer type l');

test('testing i-i-s-printers-and-papers-printer-type-l', function(assert) {
  visit('/i-i-s-printers-and-papers-printer-type-l');
